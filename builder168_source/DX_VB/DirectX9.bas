...
Public Const MAX_DEVICE_IDENTIFIER_STRING As Long = 512
Public Const D3DSGR_NO_CALIBRATION As Long = 0
Public Const D3DSGR_CALIBRATE As Long = 1
Public Const D3D_TRUE As Long = 1
Public Const D3D_FALSE As Long = 0
Public Const D3D_OK As Long = 0
...
Public Function D3DColorMake(ByVal r As Single, ByVal g As Single, ByVal b As Single, ByVal a As Single) As Long
  D3DColorMake = D3DCOLOR(a * 255, r * 255, g * 255, b * 255)
End Function
